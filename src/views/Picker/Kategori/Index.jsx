  ...
  const tableInstance = useTable(
    {
      ...
      initialState: {
        ...
        sortBy: [
          {
            id: "id", // Change this to the actual ID column key
            desc: true,
          },
        ],
      },
    ...
    <>
        ...
        <form className="flex flex-col gap-2 font-sans" onSubmit={handleSubmit}>
          ...
          <div className="mt-3 justify-end flex gap-1">
            <button
              ...
              className=" bg-red-500 hover:bg-red-700 text-white font-medium py-1 px-4 rounded-md font-sans"
            >
              Batal
            </button>
            <button
              type="submit"
              className=" bg-blue-500 hover:bg-blue-700 text-white font-medium py-1 px-4 rounded-md font-sans"
            >
              Simpan
            </button>
          </div>
      ...
      >
        <div className="flex flex-col gap-2 font-sans">
          <h2 className="text-xl font-medium font-sans">
            Apakah anda yakin ingin menghapus kategori sampah?
          </h2>
          <div className="mt-3 justify-end flex gap-1">
            <button
              type="submit"
